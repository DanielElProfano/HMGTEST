...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder20a90 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer71829 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa3722 = [
        
    ];

    public function getConnection()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getConnection', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getMetadataFactory', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getExpressionBuilder', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'beginTransaction', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getCache', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getCache();
    }

    public function transactional($func)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'transactional', array('func' => $func), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->transactional($func);
    }

    public function commit()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'commit', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->commit();
    }

    public function rollback()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'rollback', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getClassMetadata', array('className' => $className), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'createQuery', array('dql' => $dql), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'createNamedQuery', array('name' => $name), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'createQueryBuilder', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'flush', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'clear', array('entityName' => $entityName), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->clear($entityName);
    }

    public function close()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'close', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->close();
    }

    public function persist($entity)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'persist', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'remove', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'refresh', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'detach', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'merge', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getRepository', array('entityName' => $entityName), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'contains', array('entity' => $entity), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getEventManager', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getConfiguration', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'isOpen', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getUnitOfWork', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getProxyFactory', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'initializeObject', array('obj' => $obj), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'getFilters', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'isFiltersStateClean', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'hasFilters', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return $this->valueHolder20a90->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer71829 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder20a90) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder20a90 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder20a90->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, '__get', ['name' => $name], $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        if (isset(self::$publicPropertiesa3722[$name])) {
            return $this->valueHolder20a90->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder20a90;
    ...
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;
    ...
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, '__isset', array('name' => $name), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;
    ...
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, '__unset', array('name' => $name), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;
    ...
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, '__clone', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        $this->valueHolder20a90 = clone $this->valueHolder20a90;
    }

    public function __sleep()
    {
        $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, '__sleep', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;

        return array('valueHolder20a90');
    }
    ...
    {
        $this->initializer71829 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer71829;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer71829 && ($this->initializer71829->__invoke($valueHolder20a90, $this, 'initializeProxy', array(), $this->initializer71829) || 1) && $this->valueHolder20a90 = $valueHolder20a90;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder20a90;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder20a90;
    }
}
